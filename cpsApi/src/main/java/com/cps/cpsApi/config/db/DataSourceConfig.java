...
@EnableJpaRepositories(
        basePackages = "com.cps.cpsApi.repository",
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        AbstractRoutingDataSource routingDataSource = new com.cps.cpsApi.config.db.MultiTenantRoutingDataSource();
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, HibernateProperties hibernateProperties) {
        ...
        emf.setPackagesToScan("com.cps.cpsApi");

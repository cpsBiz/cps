...
public interface CpsMemberCommissionRepository extends JpaRepository<CpsRewardEntity, String> {
    ...
    @Query(value = "SELECT new com.cps.common.dto.CpsMemberCommissionListDto ( A.userId, A.regDay, A.regYm, B.campaignName, A.productName, A.productPrice, " +
    ...
    @Query(value = "SELECT new com.cps.common.dto.CpsMemberCommissionDto ( " +

...
import com.cps.common.dto.CpsGiftHistoryDto;
...
public interface CpsGiftHistoryRepository extends JpaRepository<CpsGiftHistoryEntity, String> {
    ...
    @Query("SELECT new com.cps.common.dto.CpsGiftHistoryDto(A.productId, A.barcode, A.pinNo, A.awardDay, A.validDay, A.giftYn, B.brandIcon, B.brandName, B.productImageS, B.productImageL, B.productName, B.content) " +

...
public interface CpsViewScheduleRepository extends JpaRepository<CpsViewEntity, String> {
    ...
    @Query(value = "INSERT INTO SUMMARY_DAY (REG_DAY, REG_YM, CAMPAIGN_NUM, MERCHANT_ID, AGENCY_ID, AFFLIATE_ID, ZONE_ID, SITE, OS " +
            ...
            "       (SELECT C.MEMBER_NAME FROM CPS_MEMBER C WHERE C.MEMBER_ID = A.MERCHANT_ID) AS MEMBER_NAME, " +
            "       IFNULL((SELECT C.MEMBER_NAME FROM CPS_MEMBER C WHERE C.MEMBER_ID = A.AGENCY_ID AND C.TYPE = 'AGENCY'), '인라이플') AS AGENCY_NAME, " +
            "       IFNULL((SELECT C.MEMBER_NAME FROM CPS_MEMBER C WHERE C.MEMBER_ID = A.AFFLIATE_ID AND C.TYPE = 'AFFLIATE'), '인라이플') AS AFFLIATE_NAME, " +
    ...
    @Query(value = "INSERT INTO SUMMARY_HOUR (REG_DAY, REG_YM, REG_HOUR, CAMPAIGN_NUM, MERCHANT_ID, AGENCY_ID, AFFLIATE_ID, ZONE_ID, SITE, OS  " +
            ...
            "     ,  USER_COMMISSION = VALUES(USER_COMMISSION), COMFIRM_USER_COMMISSION = VALUES(COMFIRM_USER_COMMISSION), CANCEL_USER_COMMISSION = VALUES(CANCEL_USER_COMMISSION), MOD_DATE = NOW()  "
            , nativeQuery = true)
    void insertSummaryRewardMonthHour(@Param("regDay") int regDay, @Param("hour") String hour);
    ...
    @Query(value = "INSERT INTO SUMMARY_DAY (REG_DAY, REG_YM, CAMPAIGN_NUM, MERCHANT_ID, AGENCY_ID, AFFLIATE_ID, ZONE_ID, SITE, OS " +
            ...
            "     , AFFLIATE_COMMISSION = VALUES(AFFLIATE_COMMISSION), COMFIRM_AFFLIATE_COMMISSION = VALUES(COMFIRM_AFFLIATE_COMMISSION), CANCEL_AFFLIATE_COMMISSION = VALUES(CANCEL_AFFLIATE_COMMISSION), USER_COMMISSION = VALUES(USER_COMMISSION), COMFIRM_USER_COMMISSION = VALUES(COMFIRM_USER_COMMISSION), CANCEL_USER_COMMISSION = VALUES(CANCEL_USER_COMMISSION) " +
            "     , MOD_DATE = NOW() ", nativeQuery = true)
    void insertSummaryViewMonthDay(@Param("regDay") int regDay);
}

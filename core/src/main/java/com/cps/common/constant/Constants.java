...
public enum Constants {
    ...
    STAT_HOUR_EXCEPTION("3000", "노출 통계 데이터 등록 오류"),
    ...
    LINKPRICE_EXCEPTION("3000", "링크프라이스 리워드 데이터 등록 오류"),
    LINKPRICE_BLANK("3001", "링크프라이스 정보가 없습니다."),
    LINKPRICE_NOT_SEARCH("3010", "등록 할 링크프라이스 정보가 없습니다."),

    COUPANG_EXCEPTION("3000", "쿠팡 리워드 데이터 등록 오류"),
    COUPANG_BLANK("3001", "쿠팡 정보가 없습니다."),
    COUPANG_NOT_SEARCH("3010", "등록 할 쿠팡 정보가 없습니다."),
    ...
    GIFT_BRAND_EXCEPTION("3000", "기프트 브랜드 등록 오류"),
    ...
    GIFT_PRODUCT_BLANK("3001", "기프트 상품 정보가 없습니다."),
    ...
    COUPANG_STICK_SEARCH_EXCEPTION("3005", "막대사탕 개수 조회 오류"),
    COUPANG_STICK_COUNT("3011", "막대사탕 보유 개수가 부족합니다."),

    GIFTISHOW_BLANK("3001", "쿠폰 정보가 없습니다."),
    GIFTISHOW_SEARCH_EXCEPTION("3005", "코푼 조회 오류");

package com.cps.agencyService.config.db;
...
@EnableJpaRepositories(
        basePackages = "com.cps.agencyService.repository",
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        AbstractRoutingDataSource routingDataSource = new com.cps.agencyService.config.db.MultiTenantRoutingDataSource();
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, HibernateProperties hibernateProperties) {
        ...
        emf.setPackagesToScan("com.cps.agencyService");

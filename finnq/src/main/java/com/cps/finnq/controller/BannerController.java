...
import com.cps.finnq.entity.PointEntity;
import com.cps.finnq.entity.PointSettingEntity;
import com.cps.finnq.repository.PointRepository;
import com.cps.finnq.repository.PointSettingRepository;
import com.cps.finnq.service.CoupangHttpService;
...
public class BannerController {
    ...
    public String coupang(BannerPacket.Banner.CoupangRequest coupangRequest) throws Exception{
            ...
            try {
                ...
                if(response.getData().size() == 0){
                    newJsonArray.add(objectMapper.createObjectNode()
                            .put("productImage", "/finnq/img/250x250.png")
                            .put("productUrl", "https://www.mobon.net/bridge"));
                    coupangRequest.setMobon("Y");
        ...
        coupangRequest.setCoupangData(objectMapper.writeValueAsString(newJsonArray));

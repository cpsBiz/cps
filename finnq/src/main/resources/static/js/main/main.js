...
$(document).ready(function() {
    ...
    var with_aos_zone = ["10886403", "10886403", "10886403", "10886403", "10886403", "10886403"]; //aos용 지면
    var with_ios_zone = ["10886403", "10886403", "10886403", "10886403", "10886403", "10886403"]; //ios용 지면

    var serverType = $("#serverType").val();

    if (serverType == "prod") {
        with_aos_zone = ["10886585", "10886586", "10886585", "10886586", "10886585", "10886586"]; //aos용 지면
        with_ios_zone = ["10886587", "10886588", "10886587", "10886588", "10886587", "10886588"]; //ios용 지면
    }
...
function callCoupangApi(){
    ...
    var call_url = "/finnq/view/coupang"+"?adid="+adid+"&os="+os+"&coupangPoint="+coupangPoint;
    $("#mobwith").attr("src", call_url);

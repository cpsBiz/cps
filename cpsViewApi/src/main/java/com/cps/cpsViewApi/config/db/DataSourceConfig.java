...
@EnableJpaRepositories(
        basePackages = "com.cps.cpsViewApi.repository",
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        AbstractRoutingDataSource routingDataSource = new com.cps.cpsViewApi.config.db.MultiTenantRoutingDataSource();
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, HibernateProperties hibernateProperties) {
        ...
        emf.setPackagesToScan("com.cps.cpsViewApi");

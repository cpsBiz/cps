...
import com.cps.viewService.service.CpsGiftService;
...
public class CpsGiftController {
    ...
    public ResponseEntity<CpsGiftPacket.GiftInfo.GiftBrandResponse> giftProductList(@Valid @RequestBody CpsGiftPacket.GiftInfo.GiftProductRequest request) throws Exception {
        var result = new CpsGiftPacket.GiftInfo.GiftBrandResponse();

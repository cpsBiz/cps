package com.cps.cpsService.config.db;
...
@EnableJpaRepositories(
        basePackages = "com.cps.cpsService.repository",
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        AbstractRoutingDataSource routingDataSource = new com.cps.cpsService.config.db.MultiTenantRoutingDataSource();
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, HibernateProperties hibernateProperties) {
        ...
        emf.setPackagesToScan("com.cps.cpsService");

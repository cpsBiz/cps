...
import com.mobcomms.hanapay.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserPacket.UpdateUserAgreeTerms.Response> updateUserAgreeTerms(@Valid UserPacket.UpdateUserAgreeTerms.UpdateUserAgreeTermsRequest request) throws Exception {
    ...
    public ResponseEntity<UserPacket.PostUserinfo.Response> postUserinfo(@Valid UserPacket.PostUserinfo.PostUserinfoRequest request) throws Exception {

...
import com.mobcomms.hanapay.repository.OfferwallMediaRepository;
import com.mobcomms.hanapay.repository.OfferwallRepository;
	...
	public GenericBaseResponse<OfferwallInfoDto> postPomission(OfferwallDto request) throws Exception {
		...
		try{
			...
			if (null == saveChk) {
				...
				hanaGetPacket.setUsn(offerwallEntity.getUserId());
				hanaGetPacket.setQuantity(offerwallEntity.getPoint());
